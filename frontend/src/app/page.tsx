...
import { features, pipeline } from "@/lib/homeData";
  ...
  return (
    <main className="min-h-screen" style={{ background: "var(--bg-primary)" }}>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center overflow-hidden pt-16">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce" style={{ color: "var(--text-muted)" }}>
            ...
            {pipeline.map((step, i) => (
              <div key={i} className="flex items-center gap-4">
                <div className="flex flex-col items-center gap-2">
                  <div
                    className="w-14 h-14 rounded-2xl flex items-center justify-center text-xl glass"
      ...
      >
        <p className="text-sm">© 2025 AI Video TransStudio — Built with Next.js, Express & Gemini AI</p>
      </footer>
    </main>
  );
}
